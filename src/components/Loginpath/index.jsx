  ...
  return (
    <>
      <div className="flex justify-end relative">
        ...
        <div className="absolute left-16 top-[5.5rem] md:top-[7rem] w-[42%] md:w-[50%] border md:border-[1.7px] border-dashed border-[#387AB4] "></div>
      ...
      <div className="flex justify-start relative -top-10">
        <div className="absolute right-16 top-7 md:top-[1.40rem] w-[40%] md:w-[50%] border md:border-[1.7px] border-dashed border-[#CC8B8B]"></div>
        <div
        ...
        <div className="absolute right-4 top-[11.1rem] md:top-[13rem] w-[43%] md:w-[50%] border md:border-[1.7px] border-dashed border-[#CC8B8B]"></div>
      ...
      <div className="flex justify-end relative">
        ...
        <div className="absolute left-4 top-[11rem] md:top-[12.5rem] border-[#A0B789] w-[45%] md:w-[48%] border md:border-[1.7px] border-dashed"></div>
      ...
      <div className="flex justify-start relative top-[2.4rem]">
        <div className="absolute right-16 top-7 md:top-[1.35rem] border-[#387AB4] w-[45%] md:w-[48%] border md:border-[1.7px] border-dashed"></div>
        <div
        ...
        <div className="absolute right-6 md:right-7 top-[7.4rem] md:top-[9rem] border-[#387AB4] w-[45%] md:w-[50%] border md:border-[1.7px] border-dashed"></div>
      ...
      <div className="flex justify-end relative top-[2.1rem]">
        ...
        <div className="absolute left-16 top-6 md:top-[1.2rem] h-[1px] w-[42%] md:w-[50%] border md:border-[1.7px] border-dashed"></div>
        <div
        ...
        <div className="absolute left-4 top-[8rem] md:top-[9.5rem] border-[#C9C38A] w-[45%] md:w-[50%] border md:border-[1.7px] border-dashed"></div>
      ...
      <div className="flex justify-start relative top-[2.4rem] mb-20">
        <div className="absolute right-12 top-[0.8rem] md:top-[0.5rem] border-[#B17698] w-[45%] md:w-[50%] border md:border-[1.7px] border-dashed"></div>
        <div
